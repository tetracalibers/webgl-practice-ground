...
export const onload = () => {
  ...
  const uniforms = new UniformLoader(gl, ["uPseudoOn"])
  ...
  const initGuiControls = () => {
    ...
    ui.boolean("Pseudo", defaultPseudoOn, (value) => {
      uniforms.boolean("uPseudoOn", value)
    })
  }
  ...
  const configure = async () => {
    ...
    uniforms.boolean("uPseudoOn", defaultPseudoOn)
