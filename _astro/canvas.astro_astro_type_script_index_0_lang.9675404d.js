...
void main() {
  ...
  outColor.a = 1.0;
}`;window.onload=()=>{const e=new f("gl-canvas"),c=e.canvas,n=e.gl;if(!c||!n)return;let o;const i=()=>{e.fitScreen(),r()},s=()=>{e.fitScreen(),n.clearColor(0,0,0,1),n.clearDepth(1);const t=new u(n,m,v),a=[],l=["uResolution"];t.load(a,l),o=new g(n,t),e.onResize=i},r=()=>{n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),o.resolution(),n.drawArrays(n.TRIANGLE_FAN,0,3)};(()=>{s(),r()})()};
