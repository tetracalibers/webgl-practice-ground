import{S as p,P as m}from"./program.2ef84f69.js";import{U as v}from"./uniform-reflect.63d9f660.js";import{T as y}from"./timer.1ee66154.js";import{C as u}from"./clock.75804a61.js";const f=`#version 300 es
...
}`;window.onload=()=>{const o=new p("gl-canvas"),i=o.canvas,n=o.gl;if(!i||!n)return;let e,t,c;const s=()=>{o.autoResize(()=>o.fitScreen()),n.clearColor(0,0,0,1),n.clearDepth(1);const r=new m(n,f,g),a=[],x=["uResolution","uTime"];r.load(a,x),e=new v(n,r),c=new u,t=new y,t.start()},l=()=>{n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),e.time(t.elapsed),e.resolution(),n.drawArrays(n.TRIANGLE_FAN,0,3)};(()=>{s(),c.on("tick",l)})()};
