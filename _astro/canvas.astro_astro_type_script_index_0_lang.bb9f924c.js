...
`;window.onload=()=>{const o=new v("gl-canvas"),t=o.canvas,n=o.gl;if(!t||!n)return;let r,e,c;const s=()=>{o.fitScreen(),n.clearColor(0,0,0,1),n.clearDepth(1);const a=new m(n,x,_),f=[],u=["uResolution","uMouse"];a.load(f,u),e=new d(n,a),r=new g,c=new p(t),o.onResize=l},i=()=>{n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),e.resolution(),e.mouse(c.xy),n.drawArrays(n.TRIANGLE_FAN,0,3)},l=()=>{o.fitScreen(),i()};(()=>{s(),r.on("tick",i)})()};
