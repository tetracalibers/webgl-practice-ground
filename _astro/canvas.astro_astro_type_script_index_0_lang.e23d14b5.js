import{S as a,P as x}from"./program.2ef84f69.js";import{U as p}from"./uniform-reflect.63d9f660.js";const v=`#version 300 es
...
}`;window.onload=()=>{const o=new a("gl-canvas"),s=o.canvas,n=o.gl;if(!s||!n)return;let e;const c=()=>{o.autoResize(()=>o.fitScreen()),n.clearColor(0,0,0,1),n.clearDepth(1);const t=new x(n,v,y),l=[],i=["uResolution"];t.load(l,i),e=new p(n,t)},r=()=>{n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),e.resolution(),n.drawArrays(n.TRIANGLE_FAN,0,3)};(()=>{c(),r()})()};
