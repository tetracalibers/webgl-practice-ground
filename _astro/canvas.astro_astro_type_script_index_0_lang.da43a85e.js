import{S as v,P as m}from"./program.2ef84f69.js";import{U as x}from"./uniform-reflect.63d9f660.js";import{T as g}from"./timer.1ee66154.js";import{C as h}from"./clock.75804a61.js";const p=`#version 300 es
...
void main() {
  ...
  outColor.a = 1.0;
}`;window.onload=()=>{const o=new v("gl-canvas"),s=o.canvas,n=o.gl;if(!s||!n)return;let e,r,t;const a=()=>{o.fitScreen(),i()},u=()=>{o.fitScreen(),n.clearColor(0,0,0,1),n.clearDepth(1);const c=new m(n,p,d),f=[],l=["uResolution","uTime"];c.load(f,l),e=new x(n,c),t=new h,r=new g,r.start(),o.onResize=a},i=()=>{n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),e.time(r.elapsed),e.resolution(),n.drawArrays(n.TRIANGLE_FAN,0,3)};(()=>{u(),t.on("tick",i)})()};
